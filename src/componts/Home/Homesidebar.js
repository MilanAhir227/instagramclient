  ...
  return (
    <>
      <div className="slidebararea">
        <div className="logo">
          <span className="instagram-logo-home" alt="Instagram Logo" />
        </div>
        <Link to='/home' className="homemenu">
          ...
          <div className="manutext">Home</div>
        </Link>
        <Link to='/home' className="homemenu">
          <div className="menuicon">
            <svg
          ...
          <div className="manutext">Search</div>
        </Link>
        <Link to='/home' className="homemenu">
          <div className="menuicon">
            <svg
          ...
          <div className="manutext">Explore</div>
        </Link>
        <Link to='/home' className="homemenu">
          <div className="menuicon">
            <svg
            ...
            >
              <path
                d="M2.04883 7.00195H21.9498"
                stroke="#262626"
                stroke-width="2"
                stroke-linejoin="round"
              />
              <path
                d="M13.5039 2.00098L16.3619 7.00198"
                stroke="#262626"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
              />
              <path
                d="M7.20703 2.10999L10.002 7.00199"
                stroke="#262626"
                stroke-width="2"
                stroke-linecap="round"
                stroke-linejoin="round"
          ...
          <div className="manutext">Reels</div>
        </Link>
        <Link to='/home' className="homemenu">
          <div className="menuicon">
            <svg
            ...
            >
              <path
                d="M12.0032 2.00098C13.3032 1.95924 14.5984 2.17924 15.8117 2.64792C17.025 3.11661 18.1318 3.8244 19.0661 4.72925C20.0005 5.63411 20.7435 6.71755 21.2508 7.91521C21.7582 9.11286 22.0197 10.4003 22.0197 11.701C22.0197 13.0017 21.7582 14.2891 21.2508 15.4868C20.7435 16.6844 20.0005 17.7679 19.0661 18.6727C18.1318 19.5776 17.025 20.2854 15.8117 20.754C14.5984 21.2227 13.3032 21.4427 12.0032 21.401C11.0253 21.4037 10.0515 21.2745 9.1082 21.017C8.93122 20.9687 8.74299 20.9828 8.5752 21.057L6.5912 21.933C6.47124 21.9857 6.34016 22.0082 6.20947 21.9985C6.07878 21.9888 5.95247 21.9472 5.84162 21.8773C5.73076 21.8074 5.63875 21.7114 5.57364 21.5977C5.50854 21.4839 5.47233 21.356 5.4682 21.225L5.4142 19.445C5.40969 19.3369 5.38346 19.2308 5.33708 19.133C5.29069 19.0353 5.22509 18.9478 5.1442 18.876C4.14037 17.9723 3.341 16.8649 2.7995 15.6275C2.25801 14.3902 1.98686 13.0515 2.0042 11.701C1.9966 10.3995 2.25234 9.10999 2.75603 7.90993C3.25972 6.70987 4.00096 5.6241 4.93515 4.71794C5.86934 3.81178 6.97717 3.10395 8.19201 2.63703C9.40685 2.17011 10.7026 1.95376 12.0032 2.00098Z"
                stroke="#262626"
                stroke-width="1.739"
          ...
          <div className="manutext">Messages</div>
        </Link>
        <Link to='/home' className="homemenu">
          <div className="menuicon">
            <svg
        ...
        <Link to='/home' className="homemenu">
          ...
          <div className="manutext">Create</div>
        </Link>
        <Link to='/home' className="homemenu">
          <div className="menuicon">
            <img
              src={Url() + '/images/user/' + User.profileimg}
              className="manuprofile"
            />
          </div>
          <div className="manutext">Profile</div>
        </Link>
      </div>
      ...
      <div className="slidebararea">
        <Link to='/home' className="homemenu">
          ...
          <div className="manutext">More</div>
        </Link>
      </div>
    </>
  );
